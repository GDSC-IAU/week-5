...
Product(
  id: 8,
  name: 'Rose Bush',
  imageUrl: 'lib/assets/Rose_Bush.jpg',
  price: 34.99,
  description:
      'Rose Bush is a classic outdoor plant known for its beautiful and fragrant blossoms. It\'s a symbol of love and is perfect for gardens and outdoor landscapes.',
  ...
  id: 9,
  name: 'Lavender',
  imageUrl: 'lib/assets/Lavender.jpg',
  price: 26.99,
  description:
      'Lavender is a fragrant herb known for its soothing aroma and lovely purple flowers. It\'s commonly used in gardens, landscaping, and for various culinary and aromatherapy purposes.',
  category: 'Outdoor Plants',
),
];
